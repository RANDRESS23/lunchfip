...
export const TopContentTable = ({ estudiantesCount, filterValue, statusFilter, visibleColumns, setVisibleColumns, setStatusFilter, setFilterValue, setPage, setRowsPerPage }: TopContentTableProps) => {
