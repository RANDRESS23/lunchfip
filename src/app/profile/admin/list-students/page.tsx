  ...
  return (
    <div className='lg:ml-[290px] pt-24 pb-10 h-screen relative pr-9 font-inter-sans bg-grid-small-black dark:bg-grid-small-white flex flex-col items-center'>
      ...
      <TitleAnimated
        ...
        isTextLeft
      />
      <p className='w-full z-10 -mt-3 mb-9 text-p-light dark:text-p-dark'>En esta sección podrás visualizar a los estudiantes registrados dentro de LunchFip, así como también cambiar sus estados de <span className='italic'>{'"Activo"'}</span> a <span className='italic'>{'"Inactivo"'}</span> o viceversa.</p>
      <StudentsTable
