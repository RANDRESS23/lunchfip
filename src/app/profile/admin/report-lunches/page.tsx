  ...
  return (
    <div className='lg:ml-[290px] pt-24 pb-10 relative px-9 font-inter-sans bg-grid-small-black dark:bg-grid-small-white flex flex-col items-center'>
      ...
      <TitleAnimated
        ...
        isTextLeft
      />
      <p className='w-full z-10 -mt-3 mb-9 text-p-light dark:text-p-dark text-center lg:text-left'>En esta sección podrás visualizar a los estudiantes que reservaron almuerzo dependiendo de la fecha ingresada, así como también si se les entregó o no el almuerzo correspondiente.</p>
      <StudentsTable />
    </div>
  )
}
