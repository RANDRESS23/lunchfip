  ...
  return (
    <div className='lg:ml-[290px] pt-24 pb-10 h-screen relative px-9 font-inter-sans bg-grid-small-black dark:bg-grid-small-white flex flex-col items-center'>
      ...
      <TitleAnimated
        ...
        isTextLeft
      />
      <p className='w-full z-10 -mt-3 mb-9 text-p-light dark:text-p-dark text-center lg:text-left'>En esta sección podrás visualizar diferentes estadísticas referente a los almuerzos. Esta información la encontrarás en gráficas minimalistas para que te ayuden a una mejor comprensión de las estadísticas.</p>
      <DashBoardSection />
    </div>
  )
}
