  ...
  return (
    <div className='lg:ml-[290px] pt-24 pb-10 h-screen relative px-9 font-inter-sans bg-grid-small-black dark:bg-grid-small-white flex flex-col items-center'>
      ...
      <TitleAnimated
        ...
        isTextRowMobile
      />
      <p className='w-full z-10 -mt-3 mb-5 text-p-light dark:text-p-dark text-center lg:text-left'>En esta sección podrás recargar el saldo al estudiante escaneando su código QR personal o mediante la digitalización de su número de documento.</p>
      <div className='w-full flex flex-col lg:flex-row gap-10 pb-10'>
        <div className='w-full lg:w-3/6'>
          <TabSections />
        </div>
        <div className='hidden lg:flex w-3/6 justify-center items-center relative z-10'>
          <Image
