          ...
          {(onClose) => (
            <>
              <div className='relative bg-grid-black dark:bg-grid-white'>
                ...
                <ModalFooter className='flex flex-col lg:flex-row items-center gap-4'>
                  <div className='w-full lg:w-3/5 flex flex-col lg:flex-row justify-center z-10'>
                    <MyInput
                      type='number'
                  ...
                  <div className='w-full lg:w-2/5 flex flex-col justify-center items-end gap-3'>
                    <ButtonLitUpBorders
                      type="button"
