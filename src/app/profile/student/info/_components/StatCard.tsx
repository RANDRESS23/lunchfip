    ...
    <>
      {
        !loading
          ? (
              <div className="w-48 relative bg-grid-black dark:bg-grid-white flex flex-col justify-center items-center gap-3 p-5 border border-black dark:border-white rounded-lg">
